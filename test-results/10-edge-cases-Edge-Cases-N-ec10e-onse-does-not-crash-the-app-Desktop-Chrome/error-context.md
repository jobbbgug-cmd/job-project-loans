...
- Name: 10-edge-cases.spec.ts >> Edge Cases & Negative Tests >> TC-EDGE-07 malformed API response does not crash the app
- Location: tests/e2e/10-edge-cases.spec.ts:76:7
