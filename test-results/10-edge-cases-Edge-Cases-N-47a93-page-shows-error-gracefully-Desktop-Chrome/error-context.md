...
- Name: 10-edge-cases.spec.ts >> Edge Cases & Negative Tests >> TC-EDGE-04 simulated API error on payments page shows error gracefully
- Location: tests/e2e/10-edge-cases.spec.ts:44:7
