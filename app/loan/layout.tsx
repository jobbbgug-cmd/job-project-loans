...
const NAV_KEYS = ['dashboard', 'loans', 'payments', 'tracking', 'customers', 'users', 'parser'] as const;
const NAV_HREFS: Record<string, string> = {
  dashboard: '/loan/dashboard', loans: '/loan/loans', payments: '/loan/payments',
  tracking: '/loan/tracking', customers: '/loan/customers', users: '/loan/users', parser: '/loan/parser',
};
